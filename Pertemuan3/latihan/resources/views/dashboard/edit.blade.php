<x-dashboard-layout>
    ...
    {{-- Styling Tambahan Khusus Trix agar tidak gepeng --}}
    <style>
    ...
    <div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="md:flex md:items-center md:justify-between mb-8">
            <div class="min-w-0 flex-1">
                <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">Edit Post</h2>
                <p class="mt-1 text-sm text-gray-500">Perbarui informasi artikel Anda.</p>
            </div>
        </div>
                ...
                <form action="{{ route('dashboard.update', $post->slug) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        <div class="flex justify-between">
                            ...
                            <span class="text-xs text-gray-500">Otomatis terisi, edit jika perlu.</span>
                        </div>
                        <div class="mt-2">
                    ...
                    <div>
                        ...
                        <div class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10 bg-gray-50">
                            <div class="text-center">
                                {{-- Preview Image Logic --}}
                                @if($post->image)
                                    <img src="{{ asset('storage/' . $post->image) }}" class="img-preview mb-4 max-h-64 mx-auto rounded-lg shadow-md object-cover block">
                                    <div id="upload-icon-wrapper" style="display: none;">
                                @else
                    ...
                    <div class="flex items-center justify-end gap-x-4 border-t border-gray-900/10 pt-6">
                        ...
                        <button type="submit" class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Update Post</button>
                    </div>
